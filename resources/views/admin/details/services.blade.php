...
@extends('admin.layouts.app')
    ...
    @endif
	  <style>#services{color:orange;}main{background-color:lightgray}</style>
    ...
    <head>
		...
		<link href="{{asset('assets/pages/assets/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
                        ...
                        <div class="form-group m-b-20">
                            ...
                            <option></option>
                            <option value="Refreshing">Refreshing Tab</option>
                            <option value="Bootstrap">Bootstrao Tab</option>
                            <option value="Components">Components Tab</option>
                            <option value="Speed">Speed Tab</option>
                            <option value="Customise">Customise Tab</option>
                            <option value="Updates">Updates Tab</option>
                          </select>
												</div>
												<div class="row">
													<div class="col-sm-12">
